...
public class YuME_editorConfig : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        editorData.gridLayerHeightScaler = EditorGUILayout.FloatField("Grid Layer Height Scaler", editorData.gridLayerHeightScaler);
        ...
        editorData.useAlternativeKeyShortcuts = EditorGUILayout.Toggle("Alternative Keys", editorData.useAlternativeKeyShortcuts);
        EditorGUILayout.EndVertical();
