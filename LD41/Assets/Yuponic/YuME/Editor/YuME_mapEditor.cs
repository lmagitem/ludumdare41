...
public class YuME_mapEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        if (!Application.isPlaying)
        {
            ...
            {
                Application.OpenURL("https://assetstore.unity.com/packages/tools/level-design/yume-yuponic-map-editor-75747");
            }
        ...
        if (toolEnabled)
        {
            ...
            switch (selectedTool)
            {
                ...
                case toolIcons.gridUpTool:
					...
					{
						gridHeight+=globalScale * editorData.gridLayerHeightScaler;
					}
					selectedTool = previousSelectedTool;
                    break;
    ...
    {
        GameObject mainMap = Instantiate(sourceMap);
        YuME_mapManagerFunctions.getGridSceneObjectReference(mainMap);
    }
    ...
    public static Vector2 gridDimensions
    {
        get
        {
            return editorData.gridDimensions;
        }
        set
        {
            editorData.gridDimensions = value;
